...
public class Object3D
{
    ...
    public void scale(double x, double y, double z, boolean local)
    {
        applyMatrix(Matrix.makeScale(x,y,z), local);
    }
    ...
    public void setDirection(Vector direction)
    {
        ...
        Vector targetPosition = new Vector(
            position.values[0] + direction.values[0],
            position.values[1] + direction.values[1],
            position.values[2] + direction.values[2]);
